            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white  border-gray-200">
                    ...
                    <div class="text-right">
                        <button id="task_filter_btn" type="button" class="bg-blue-500 text-white px-3 py-1 mb-6 rounded-sm">{{ request('client_id') || request('status') || request('emailsent') ? 'Close Filter' : 'Filter' }}</button>
                    </div>
